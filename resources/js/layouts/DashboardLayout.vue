        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <button class="btn btn-info btn-sm" style="flot:left" @click="setLang('en')">English</button>
                    <button class="btn btn-success btn-sm" style="flot:left;margin-left:10px" @click="setLang('bn')">বাংলা</button>
                    <!-- Topbar Search -->
